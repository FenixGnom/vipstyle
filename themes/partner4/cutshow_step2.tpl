...
<div class="titleName center" style="position:relative;"><span>Способ доставки</span>
...
<form id="thiszakaz" ACTION="/cut/show_step3" METHOD="POST">
	<table border="0" cellpadding="2" cellspacing="1" width="585px" class="center" style="margin-top:20px;">	

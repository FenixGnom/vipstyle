...
<div class="title center" style="position:relative;"><span>Покупательская корзина</span>
	{if count($template_data->offers())>0}<span style="position:absolute;top:10px;right:3px;">Шаг 1 из 5</span>{/if}
</div>

<div id="cutshow_it" class="catShowBlock">
	{if count($template_data->offers())>0}
	<table border="0" cellpadding="2" cellspacing="1" width="500px" class="center" style="margin-top:10px;">
		<tr class="thead">
			<td>Название</td>
			<td>Модель</td>
			<td>Р-р</td>
	...
	<div class="center buttonCuts" style="height:30px;">

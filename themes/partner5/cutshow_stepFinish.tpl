...
<div id="ordersShow">	
	<div class="title center" style="position:relative;"><span>Подтверждение заказа</span>
	...
	{/literal}
	<table class="center" style="margin-top:20px;width:520px;">
		<tbody>                   
	...
	<script>
		...
		function orderSend()
		{
				if(sLoad==0){
					...
					$('#ordersShow').css('background','url("/themes/partner4/images/loadinfoa.gif") center center no-repeat');

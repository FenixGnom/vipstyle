...
{/literal}
	{if $template_data->is_result()}  
		<div class="title center" style="position:relative;"><span>Ваш Заказ принят!</span></div>  
	...
	{else}
	<div class="title center" style="position:relative;"><span>Ваш Заказ не принят!</span></div> 		
		<div class="accepted">
			<h4>Номер Вашего заказа {$template_data->order()}</h4>	
		</div>
	{/if}

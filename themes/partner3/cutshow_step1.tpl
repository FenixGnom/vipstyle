...
<div class="contentTitle" style="position:relative;"><span>Адрес доставки</span>
<span style="position:absolute;top:0px;right:3px;">Шаг 2 из 5</span>
</div>
{literal}
<style>
	input.bitButton{
...
<form id="zakaz" method="post"  action="/cut/show_step2">
		<table border="0" cellpadding="3" cellspacing="1" style="margin-top:20px;" width="470px" class="zakaz center">
			<tr class="trow2">
			...
			<tr class="trow1">
				<td  ><b>Почтовый индекс</b> (125284) <span style="color:red">*</span><span id="index_links" ><a href='http://info.russianpost.ru/servlet/department' target='_blank'><br>список индексов России</a></span><div id="row-index">пустое поле</div></td>
				<td><input type="text" maxlength="80"  style="width:200px;" name="indeks" id="indeks" VALUE="{$template_data->index()}"></td>
			</tr>
			<tr class="trow2">
			...
			<tr class="trow1">
				...
				<td><textarea rows="4" cols="17"  style="width:200px;" name="adres" id="adres" >{$template_data->address()}</textarea></td>
			</tr>
			...
			<tr class="trow1">
				...
				<td><textarea rows="2" cols="17"  style="width:200px;" name="text" maxlength="150" >{$template_data->comments()}</textarea></td>
			</tr>
			<tr class="trow2">

...
<div id="ordersShow">
	<div class="contentTitle" style="position:relative;"><span>Подтверждение заказа</span>
...
{/literal}
	<table class="center" style="width:470px;">
		<tbody>                   
...
<script>
	...
	function orderSend()
	{
			if(sLoad==0){
				...
				$('#ordersShow').css('background','url("/themes/partner3/images/loadinfoa.gif") center center no-repeat');

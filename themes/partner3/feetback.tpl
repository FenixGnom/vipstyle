...
<div class="contentTitle"><span>Обратная связь</span>
</div>
...
<table border="0" cellpadding="3" cellspacing="1" width="440px" class="zakaz center">
	<tr class="trow1">
    ...
    <tr class="trow2">
    	...
    	&nbsp;&nbsp;&nbsp;&nbsp;
    	<input type="submit" value="отправить" name="go_mail" style="border: 1px solid #173452; cursor:hand;width:80px; font-weight:bold;text-align:center;"></td>
	</tr>
    <tr class="trow1">
    	<td></td>

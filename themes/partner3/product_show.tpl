...
<div class="ProductShowBlock center" id="inThisLoaders3">
        ...
        <form id="cut" name="product_zak" onsubmit="return false;">
            ...
            <div class="ProductShowParams left">
                <div>
				    ...
				    Модель:
                            <select onChange="get_query('/catalog/showsex/wages/{$template_data->id()}/sex/'+this.value,'window_wages');" name="model_change" style="width:200px;">
            ...
            <div class="ResProductTxt">
               ...
               <b>Выбранный товар:</b><br>
				...
				<br>				
				<b>цвет:</b> 
				<span id="colors">{$template_data->color_default()->name()}</span>;<br>
				{if count($template_data->sizes())>0}
            ...
            <div class="buttonAddCart">
                <input type="button"  style="border:0px;width:104px;height:24px;background: url('/themes/partner3/images/zakaz.jpg');" onclick="post_ord('cut','/catalog/insertcut/');">
            </div>
    </form>

var idLoadersInOffersInfo='inThisLoaders2';
...
function post_orders(id,link,targetid)
  ...
  function post(id,link,targetid)
           ...
           {
						loadLoaderProd('/themes/partner2/images/loadinfoa.gif');
						jQuery.ajax({
						dataType: 'json',
						type: "GET",
...
function loadLoaderProd(imgLoaderPath)
{
	...
	ww=ww-4;
	hh=hh-4;
	var html='<div id="inAjaxLoaders" style="position:absolute;top:2px;left:2px;width:'+ww+'px;height:'+hh+'px;background: url(\''+imgLoaderPath+'\') center no-repeat #FFF;"></div>';

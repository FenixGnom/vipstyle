...
<table border="0" cellpadding="3" cellspacing="1" width="360px" class="zakaz center">
	<tr class="trow1">
    ...
    <tr class="trow2">
    	...
    	<td style="padding-right:0px;"><img src="{$template_data->captcha()}" alt="Код" title="Код" width="75" height="16" align="top" style="margin-top:3px;">&nbsp;&nbsp;&nbsp;&nbsp;
    	<input type="text" name="check_num" style="width:53px;color:#173452;margin-top:3px; font-size:12px; height:15px;" maxlength="11" value="код" onclick="this.value='';" >
    	
    	<input type="submit" value="отправить" name="go_mail" style="border: 1px solid #173452; cursor:pointer; width:80px; font-size:11px;text-align:center;"></td>
	</tr>
    <tr class="trow1">
    	<td></td>

...
{/literal}
	...
	{if $template_data->is_result()}    
		<div class="titleContent" style="position:relative;"><span>Ваш Заказ принят!</span></div>  
		...
		<div >		
			<a  style="background:  #000000;border: 1px solid #000000;color: #FFFFFF;cursor: pointer;font-size: 13px;margin-top: 5px;padding: 2px 3px;" href="http://maykoplat.ru/?id={$template_data->order()}&email={$template_data->email()}" >Оплатить</a>
		</div>
	{else}

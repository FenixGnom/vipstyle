...
<div class="TitleContent center" style="position:relative;"><span>Адрес доставки</span>
...
<form id="zakaz" method="post"  action="/cut/show_step2">		
		<table border="0" cellpadding="3" cellspacing="1" style="margin-top:20px;" width="550px" class="zakaz center">
			<tr class="trow2">

...
<div class="TitleContent center" style="position:relative;"><span>Способ доставки</span>
<span style="position:absolute;top:0px;right:3px;">Шаг 3 из 5</span>
</div>
{literal}
	<style>
		input.bitButton{
...
<form id="thiszakaz" ACTION="/cut/show_step3" METHOD="POST">
	<table border="0" cellpadding="2" cellspacing="1" width="550px" class="center" style="margin-top:20px;">	
